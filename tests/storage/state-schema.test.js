...
import { createRecord } from "../../scripts/domain/record.js";
...
test("validação rejeita Record ligado a Subject inexistente", () => {
  const state = createState();
  state.collections.records["record-orphan"] = createRecord(
    {
      id: "record-orphan",
